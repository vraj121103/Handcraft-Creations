		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">View State</h1>
									...
									<tbody>
											...
											while ($rw=$r->fetch_object())
											 ...
											 ?><tr>
											    ...
											    <td><a href="deletestate.php?delsid=<?php echo "$rw->s_id"?>" class="btn btn-lg btn-primary">Delete</a></td>
	                                             <td><a href="updatestate.php?upsdid=<?php echo "$rw->s_id"?>" class="btn btn-lg btn-primary">Update</a></td>
	                                             	</tr>
												<?php
											}
											?>
