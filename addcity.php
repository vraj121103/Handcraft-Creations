...
if (isset($_POST['submit']))
 {
	...
	$e=$obj->query("insert into city(s_id,city) values ('$cname','$sname')");
	if($e){
								...
								<div class="tab-pane fade show active" id="account" role="tabpanel">
									...
									<div class="card">
										<div class="card-header">
											...
											<h5 class="card-title mb-0">State info</h5>
										</div>
										<div class="card-body">
											<form method="Post">
												<div class="row">
                                            ...
                                            <select id="c" name="c">
	                                           <option value="">- - - Select City- - -</option>
	                                              ...
	                                              <option value="<?php echo $res->s_id ;?>" required><?php echo $res->s_name ;?></option>
	                                              <?php
                                                   }
	                                                 ?>
                                             </select></td>
														...
														<div class="mb-3">
                                                            ...
                                                            <input type="text" class="form-control" id="city" name="city" placeholder="city" required></td>
														</div>
													</div>
													<div class="col-md-4">
			                                           ...
			                                           <input type="submit" name="submit" id="submit" value="Add" class="btn btn-lg btn-primary" required>
											</form>
