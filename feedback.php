...
$result =$obj->query("select * from feedback");
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">View Feedback</h1>
									...
									<tbody>
										...
										while($row=$result->fetch_object())
										{
                                          ...
                                          <tr>
											    ...
											    <td><a href="feedbackdelete.php?delid=<?php echo "$row->id"?>" class="btn btn-lg btn-primary">Delete</a></td>
