...
if (isset($_POST['submit']))
 {
    ...
    {
      $eee =$obj->query("insert into product(pname,description,size,price,company,cat,subcat,img) values ('$pname','$description','$size','$price','$company','$cat','$subcat','$filename')");
...
<head>
	...
	<title>Handcraft Creations</title>
												...
												<div class="row">
													<div class="col-md-8">
														<div class="mb-3">
        													...
        													<input type="text" class="form-control" id="pname" name="pname" placeholder="Product name" required></td>
														</div>
														<div class="mb-3">
															<label for="inputUsername" class="form-label">Description</label>
	    													<textarea rows="2" class="form-control" id="description" name="description" placeholder="Tell something about Product" required></textarea>
														</div>
														<div class="mb-3">
															<label for="inputUsername" class="form-label">Size</label>
														...
														<div class="mb-3">
		                                                  ...
		                                                  <br><select id="category" name="category" class="form-control" required>
													...
													<br><select id="subcategory" name="subcategory" class="form-control" required>
												  ...
												  <?php
													...
													<br><input type="file" name="f" id="f" class="form-control" required>
														</div>
													</div>
												</div>
