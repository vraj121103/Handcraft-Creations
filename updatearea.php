...
$category=$obj->query("select * from state");
$c = $obj->query("select * from city");


$sub=$obj->query("select * from area where a_id='$id'");
$subc=$sub->fetch_object();
...
if (isset($_POST['submit']))
 {
	...
	$e=$obj->query("insert into area(s_id,c_id,area_name) values ('$sname','$cname','$aname')");
	if($e){
								...
								<div class="tab-pane fade show active" id="account" role="tabpanel">
									...
									<div class="card">
										<div class="card-header">
											...
											<h5 class="card-title mb-0">Area info</h5>
										</div>
										<div class="card-body">
											<form method="Post">
												<div class="row">
													<div class="col-md-8">
														<div class="mb-3">
															<label for="name" class="form-label">State</label><br>
                                                       <select id="s" name="s">
	                                         ...
	                                         <option value="<?php echo $cat->s_id ;?>" <?php if($subc->s_id=="$cat->s_id"){echo "selected";}?>><?php echo $cat->s_name;?></option>
	                                              <?php
                                                   }
	                                                 ?>
                                              </select></td>
	                                           ...
	                                           <option value="">- - - Select City- - -</option>
	                                              <?php 
	                                                    while($cat=$c->fetch_object())
	                                                    {
	                              
	                                               ?>

	                                         <option value="<?php echo $cat->c_id ;?>" <?php if($subc->c_id=="$cat->c_id"){echo "selected";}?>><?php echo $cat->city;?></option>
	                                              <?php
                                                   }
	                                                 ?>
                                              </select></td>
                                                           ...
                                                           <input type="text" class="form-control" id="area" name="area" placeholder="area" value="<?php echo $subc->area_name;?>"></td>
														</div>
													</div>
													<div class="col-md-4">
