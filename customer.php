...
$result =$obj->query("select * from customer");
									...
									<tbody>
										...
										while($row=$result->fetch_object())
										{
                                          ...
                                          <tr>
												...
												<td><a href="dcus.php?delid=<?php echo "$row->id"?>" class="btn btn-lg btn-primary">Delete</a></td>
	                                             <td><a href="ucus.php?updid=<?php echo "$row->id"?>" class="btn btn-lg btn-primary">Update</a></td>
											    </tr>
                                          <?php
										}
										?>
