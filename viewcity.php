                                            ...
                                            while ($rw=$r->fetch_object())
                                             {
                                               ...
                                               $ccc=$rrs->fetch_object();
                                                ?><tr>
                                                <td><?php echo $rw->c_id ;?></td>
                                                <td><?php echo $ccc->s_name ;?></td>
                                                <td><?php echo $rw->city ;?></td>
                                                 <td><a href="deletecity.php?delcid=<?php echo "$rw->c_id"?>" class="btn btn-lg btn-primary">Delete</a></td>
                                                 <td><a href="updatecity.php?updcid=<?php echo "$rw->c_id"?>" class="btn btn-lg btn-primary">Update</a></td>
                                                    </tr>
                                                <?php
                                            }
                                            ?>
