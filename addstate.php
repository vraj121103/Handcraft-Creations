...
if (isset($_POST['submit']))
 {
	...
	$e=$obj->query("insert into state(s_name) values ('$sname')");
	if($e){
...
<input type="text" class="form-control" id="state" name="state" placeholder="State" required></td>
														</div>
