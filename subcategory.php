...
if (isset($_POST['submit']))
 {
	...
	$e=$obj->query("insert into subcategory(c,sc) values ('$cname','$sname')");
	if($e){
	                                              ...
	                                              <?php
	                                                 ...
	                                                 ?>
														...
														<div class="mb-3">
                                                           ...
                                                           <input type="text" class="form-control" id="sname" name="sname" placeholder="Sub-Category" required></td>
														</div>
													</div>
													<div class="col-md-4">
