...
$id = $_GET['updid'];
$sub=$obj->query("select * from subcategory where id='$id'");
...
if (isset($_POST['submit']))
 {
	...
	$e=$obj->query("update subcategory set c='$cname',sc='$sname' where id='$id'");
	if($e){
									...
									<div class="card">
										...
										<div class="card-body">
											<form method="Post">
	                                         ...
	                                         <option value="<?php echo $cat->id ;?>" <?php if($subc->c=="$cat->id"){echo "selected";}?>><?php echo $cat->cname;?></option>
	                                              <?php
                                                   }
	                                                 ?>
                                           </select>
														...
														<div class="mb-3">
                                                           ...
                                                           <input type="text" class="form-control" id="sname" name="sname" placeholder="Sub-Category" value="<?php echo $subc->sc;?>"></td>
														</div>
													</div>
													<div class="col-md-4">
