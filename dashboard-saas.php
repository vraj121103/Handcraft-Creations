...
$orders = $obj->query("select * from orders");
					...
					<div class="row">
						<div class="col-md-4 stretch-card grid-margin">
							<div class="card bg-gradient-danger card-img-holder text-white">
								<div class="card-body">
									...
									<h3 class="font-weight-normal mb-4">All Orders
										<i class="mdi mdi-chart-line mdi-24px float-right"></i>
									</h3>

									<?php
									$dash_category_query = "SELECT * from orders";
									$dash_category_query_run = mysqli_query($obj, $dash_category_query);
									if ($category_total = mysqli_num_rows($dash_category_query_run)) {
										echo '<h2 class="mb-5"> ' . $category_total . ' </h2>';
									} else {
										echo '<h2 class="mb-5"> No Data </h2>';
									}
									?>
						...
						<div class="col-md-4 stretch-card grid-margin">
							<div class="card bg-gradient-info card-img-holder text-white">
								<div class="card-body">
									<h3 class="font-weight-normal mb-4">All Customers
										<i class="mdi mdi-chart-line mdi-24px float-right"></i>
									</h3>

									<?php
									$dash_customer_query = "SELECT * from customer";
									$dash_customer_query_run = mysqli_query($obj, $dash_customer_query);
									if ($customer_total = mysqli_num_rows($dash_customer_query_run)) {
										echo '<h2 class="mb-5"> ' . $customer_total . ' </h2>';
									} else {
										echo '<h2 class="mb-5"> No Data </h2>';
									}
									?>
						...
						<div class="col-md-4 stretch-card grid-margin">
							<div class="card bg-gradient-success card-img-holder text-white">
								<div class="card-body">
									<h3 class="font-weight-normal mb-3">Vendors
										 <i class="mdi mdi-diamond mdi-24px float-right"></i>
									</h3>
									<?php
									$dash_vendor_query = "SELECT * from vendor";
									$dash_vendor_query_run = mysqli_query($obj, $dash_vendor_query);
									if ($vendor_total = mysqli_num_rows($dash_vendor_query_run)) {
										echo '<h2 class="mb-5"> ' . $vendor_total . ' </h2>';
									} else {
										echo '<h2 class="mb-5"> No Data </h2>';
									}
									?>
