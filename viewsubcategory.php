...
$r =$obj->query("select * from subcategory");
		...
		<div class="main">
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">View SubCategory</h1>
								...
								<table class="table">
									...
									<tbody>
											...
											while ($rw=$r->fetch_object())
											 {
											 	$rr =$obj->query("select * from category where id='$rw->c'");
                                              $cc=$rr->fetch_object();
												?><tr>
												<td><?php echo $rw->id ;?></td>
											    <td><?php echo $cc->cname ;?></td>
											    <td><?php echo $rw->sc ;?></td>
											     <td><a href="dsc.php?delid=<?php echo "$rw->id"?>" class="btn btn-lg btn-primary">Delete</a></td>
	                                             <td><a href="usc.php?updid=<?php echo "$rw->id"?>" class="btn btn-lg btn-primary">Update</a></td>
	                                             	</tr>
												<?php
											}
											?>
